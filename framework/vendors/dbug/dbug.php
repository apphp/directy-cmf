...
class dBug {
	...
	function makeTDHeader($type,$header) {
		echo "<tr>
				...
				<td class=\"dBug_".$type."White\">"; /* [#003 added by ApPHP] */
	}
	...
	function varIsObject($var) {
		...
		if(is_object($var)) {
			...
			// [#004 added by ApPHP]
			// show properties single CActiveRecord object 
			if($var instanceof CActiveRecord){				
		...
		echo <<<SCRIPTS
			...
			<style type="text/css">
				table.dBug_array,table.dBug_object,table.dBug_resource,table.dBug_resourceC,table.dBug_xml {
					font-family:Verdana, Arial, Helvetica, sans-serif;color:#000000;font-size:12px;width:auto;
				...
				/* array */
				table.dBug_array { background-color:#006600; padding:1px; }
				table.dBug_array tr:hover td { border: 1px solid #006600; color:#000; }
				table.dBug_array td { background-color:#FFFFFF; height:20px !important; border: 1px solid #006600; padding:3px 3px; }
				table.dBug_array td td { padding:4px 8px; }
				table.dBug_array td.dBug_arrayWhite { background-color:#FFFFFF; }
				table.dBug_array td.dBug_arrayHeader { background-color:#009900; padding:3px 5px; text-shadow: none; }
				table.dBug_array td.dBug_arrayKey { background-color:#CCFFCC; padding:3px 5px; }
				
				/* object */
				table.dBug_object { background-color:#0000CC; padding:1px; }
				table.dBug_object tr:hover td { border: 1px solid #0000CC; color:#000; }
				table.dBug_object td { background-color:#FFFFFF; height:20px !important; border: 1px solid #0000CC; padding:3px 5px; }
				table.dBug_object td.dBug_objectWhite { background-color:#FFFFFF; }
				table.dBug_object td.dBug_objectHeader { background-color:#4444CC; padding:3px 5px; text-shadow: none; }
				table.dBug_object td.dBug_objectKey { background-color:#CCDDFF; padding:3px 5px; }
				
				/* resource */
				table.dBug_resourceC { background-color:#884488; padding:1px; }
				table.dBug_resourceC td { background-color:#FFFFFF; height:20px !important; border: 1px solid #884488; padding:4px 10px; }
				table.dBug_resourceC td.dBug_resourceCHeader { background-color:#AA66AA; padding:2px 5px; text-shadow: none; }
				table.dBug_resourceC td.dBug_resourceCKey { background-color:#FFDDFF; padding:2px 5px; }
				
				/* resource */
				table.dBug_resource { background-color:#884488; padding:1px; }
				table.dBug_resource td { background-color:#FFFFFF; height:20px !important; border: 1px solid #884488; padding:4px 10px; }
				table.dBug_resource td.dBug_resourceHeader { background-color:#AA66AA; padding:2px 5px; text-shadow: none; }
				table.dBug_resource td.dBug_resourceKey { background-color:#FFDDFF; padding:2px 5px; }
				
				/* xml */
				table.dBug_xml { background-color:#888888; padding:1px; height:20px !important; border: 1px solid #888888; padding:4px 10px; }
				table.dBug_xml td { background-color:#FFFFFF; }
				table.dBug_xml td.dBug_xmlHeader { background-color:#AAAAAA; padding:2px 5px; text-shadow: none; }
				table.dBug_xml td.dBug_xmlKey { background-color:#DDDDDD; padding:2px 5px; }
			</style>
SCRIPTS;
	}
