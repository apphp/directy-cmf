<?php
    Website::setMetaTags(array('title'=>A::t('events', 'Edit Event Category')));
    ...
    $this->_breadCrumbs = array(
        ...
        array('label' => A::t('events', 'Edit Event Category')),
    );	
?>
...
<div class="bloc">
	...
	<div class="sub-title"><?= A::t('events', 'Edit Event Category'); ?></div>
    <div class="content">
        <?php    
        echo CWidget::create('CDataForm', array(
            'model'             => '\Modules\Events\Models\EventsCategories',
            'primaryKey'		=> $eventsCategory->id,
            'operationType'		=> 'edit',
            'action'			=> 'eventsCategories/edit/id/'.$eventsCategory->id,     
            'successUrl'		=> 'eventsCategories/manage',
            'cancelUrl'			=> 'eventsCategories/manage',
            'passParameters'	=> false,
            'method'			=> 'post',
            'htmlOptions'		=> array(
                'name'				=> 'frmEventsCategoriesEdit',                
                'autoGenerateId'	=> true
            ),
