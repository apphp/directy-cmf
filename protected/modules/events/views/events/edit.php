<?php 
    Website::setMetaTags(array('title'=>A::t('events', 'Edit Event')));
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('events', 'Edit Event')),
    );  
?>
...
<div class="bloc">
    ...
    <?php
        echo CWidget::create('CDataForm', array(
            ...
            'primaryKey'		=> $event->id,
            'operationType'		=> 'edit',
            'action'			=> 'events/edit/catId/'.$catId.'/id/'.$event->id,
...
<?php
	...
	A::app()->getClientScript()->registerScript('eventsDatetimepicker', '
