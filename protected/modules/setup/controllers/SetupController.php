        ...
        if($this->cSession->get('step') < 2){
            ...
            $result = CWidget::create('CFormValidation', array(
                'fields'=>array(
                    ...
                    'username'=>array('title'=>'Username', 'validation'=>array('required'=>true, 'type'=>'any', 'minLength'=>4)),
                    'password'=>array('title'=>'Password', 'validation'=>array('required'=>true, 'type'=>'any', 'minLength'=>4)),
                ),            
            ));
