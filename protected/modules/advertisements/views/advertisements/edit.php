<?php
    Website::setMetaTags(array('title'=>A::t('advertisements', 'Edit Advertisement')));
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('advertisements', 'Edit Advertisement')),
    );
?>
...
<div class="bloc">
    ...
    <div class="sub-title"><?= A::t('advertisements', 'Edit Advertisement'); ?></div>
    ...
    <?php
        echo CWidget::create('CDataForm', array(
            ...
            'primaryKey'        => $id,
            'operationType'     => 'edit',
            'action'            => 'advertisements/edit/id/'.$id,
            'successUrl'        => 'advertisements/manage',
            'cancelUrl'         => 'advertisements/manage',
            'passParameters'    => false,
            'method'            => 'post',
            'htmlOptions'       => array(
                'id'             => 'frmAdvertisementEdit',
                'name'           => 'frmAdvertisementEdit',
            ...
            'fields'            => array(
                'separatorBasicData' => array(
                    ...
                    'image'         => array(
                        ...
                        'deleteOptions'    => array('showLink'=>true, 'linkUrl'=>'advertisements/edit/id/'.$id.'/delete/image', 'linkText'=>A::t('advertisements', 'Delete')),
                        'fileOptions'      => array('showAlways'=>true, 'class'=>'file', 'size'=>'25', 'filePath'=>'assets/modules/advertisements/images/items/')
                    ),
                ...
                'separatorOther' => array(
                    ...
                    'created_at'    => array('type'=>'label', 'title'=>A::t('advertisements', 'Created At'), 'format'=>$dateFormat),
                    'sort_order'    => array('type'=>'textbox', 'title'=>A::t('advertisements', 'Sort Order'), 'tooltip'=>'', 'default'=>'0', 'validation'=>array('required'=>false, 'type'=>'int', 'maxLength'=>'6'), 'htmlOptions'=>array('maxLength'=>'6', 'class'=>'small')),
            ...
            'buttons'           => array(
                'submitUpdateClose' => array('type'=>'submit', 'value'=>A::t('advertisements', 'Update & Close'), 'htmlOptions'=>array('name'=>'btnUpdateClose')),
                'submitUpdate'      => array('type'=>'submit', 'value'=>A::t('advertisements', 'Update'), 'htmlOptions'=>array('name'=>'btnUpdate')),
