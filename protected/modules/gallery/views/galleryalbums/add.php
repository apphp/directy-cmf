<?php
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('gallery', 'Add Album')),
    );
?>
...
<div class="bloc">
    ...
    <?php			
        echo CWidget::create('CDataForm', array(
            ...
            'method'=>'post',
            'htmlOptions'=>array(
                'name'=>'frmGalleryAlbumsAdd',
                'enctype'=>'multipart/form-data',
                'autoGenerateId'=>true
            ),
            'requiredFieldsAlert'=>true,
            'fields'=>array(
                'album_type' => array('type'=>'select', 'title'=>A::t('gallery', 'Album Type'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'set', 'source'=>array_keys($albumTypes)), 'data'=>$albumTypes, 'htmlOptions'=>array()),
