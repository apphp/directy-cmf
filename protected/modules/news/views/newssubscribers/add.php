<?php
	Website::setMetaTags(array('title'=>A::t('news', 'Add Subscriber')));
    ...
    $fields['email'] = array('title' => A::t('news', 'Email'), 'type' => 'textbox', 'tooltip' => '', 'value' => $email, 'htmlOptions' => array('maxLength' => '128', 'class' => 'middle', 'placeholder' => '', 'id' => 'news_subscribers_email'), 'validation' => array('required' => true, 'type'=>'email', 'maxLength' => '128', 'autocomplete'=>'', 'unique' => true));
...
<div class="bloc">
    <?= $tabs; ?>
    <div class="sub-title"><?= A::t('news', 'Add Subscriber'); ?></div>
    <div class="content">
        <?php
