<?php
    Website::setMetaTags(array('title'=>A::t('reports', 'Add Report Row')));
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('reports', 'Add Report Row')),
    );
?>
...
<div class="bloc">
    ...
    <div class="sub-title" style="background-color: #fefefe;"><?= A::t('reports', 'Add Report Row'); ?></div>
    <div class="content">
    <?php
        echo $actionMessage;
        ...
        echo CWidget::create('CDataForm', array(
            ...
            'operationType'      => 'add',
            'action'             => 'reportsEntityItems/add/projectId/'.$projectId.'/reportId/'.$reportId,
            'successUrl'         => 'reportsEntityItems/manage/projectId/'.$projectId.'/reportId/'.$reportId,
