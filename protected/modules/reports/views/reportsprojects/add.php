<?php
    Website::setMetaTags(array('title'=>A::t('reports', 'Add Project')));
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('reports', 'Add Project')),
    );
?>
...
<div class="bloc">
	...
	<div class="sub-title"><?= A::t('reports', 'Add Project'); ?></div>
    <div class="content">
        <?php
			echo $actionMessage;
				...
				'fields'                => array(
					'separatorProject' => array(
					   'separatorInfo' => array('legend'=>A::t('reports', 'Project Information')),
						...
						'started_at'           	 => array('type'=>'datetime', 'title'=>A::t('reports', 'Start Date'), 'default'=>null, 'validation'=>array('required'=>false, 'type'=>'date', 'maxLength'=>10, 'minValue'=>'1900-00-00', 'maxValue'=>''), 'htmlOptions'=>array('maxlength'=>'10', 'style'=>'width:100px'), 'definedValues'=>array()),
						'finished_at'          	 => array('type'=>'datetime', 'title'=>A::t('reports', 'Finish Date'), 'default'=>null, 'validation'=>array('required'=>false, 'type'=>'date', 'maxLength'=>10, 'minValue'=>'1900-00-00', 'maxValue'=>''), 'htmlOptions'=>array('maxlength'=>'10', 'style'=>'width:100px'), 'definedValues'=>array()),
					...
					'separatorClient' => array(
					   'separatorInfo'=> array('legend'=>A::t('reports', 'Client Information')),
						...
						'client_email'           => array('type'=>'textbox', 'title'=>A::t('reports', 'Client Email'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>false, 'type'=>'email', 'maxLength' => 100), 'htmlOptions'=>array('maxLength' => 100)),
...
A::app()->getClientScript()->registerScript(
    ...
    function CalculateTotal(){
        var projectManagementPrice = $(\'#frmReportTypeAdd_project_manage_price\').val() == "" ? 0 : parseFloat($(\'#frmReportTypeAdd_project_manage_price\').val());
        var projectDesignPrice = $(\'#frmReportTypeAdd_project_design_price\').val() == "" ? 0 : parseFloat($(\'#frmReportTypeAdd_project_design_price\').val());
        var total = projectManagementPrice + projectDesignPrice;
        $(\'#frmReportTypeAdd_project_price\').val(isNaN(total) ? 0 : parseFloat(total).toFixed(2));
    }
    $(\'#frmReportTypeAdd_project_manage_price\').keyup(function() {
        CalculateTotal();
    });
    $(\'#frmReportTypeAdd_project_design_price\').keyup(function() {
        CalculateTotal();
    });
    '
    ,
