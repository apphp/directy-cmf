<?php
    Website::setMetaTags(array('title'=>A::t('users', 'Add User')));
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('users', 'Add User')),
    );
...
<div class="bloc">
    ...
    <div class="sub-title"><?= A::t('users', 'Add Users'); ?></div>
    <div class="content">
    <?php
        $fields = array();
        ...
        if($fieldCountry !== 'no'){
            $onchange = ($fieldState !== 'no') ? "users_ChangeCountry('frmUserAdd',this.value,'')" : '';
        ...
        if(count($groups)) $fields['separatorAccount']['group_id'] = array('type'=>'select', 'title'=>A::t('users', 'Group'), 'tooltip'=>'', 'default'=>$defaultGroupId, 'validation'=>array('required'=>false, 'type'=>'set', 'source'=>array_keys($groups)), 'data'=>$groups, 'htmlOptions'=>array());
        $fields['separatorAccount']['username']	= array('type'=>'textbox', 'title'=>A::t('users', 'Username'), 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'username', 'minLength'=>6, 'maxLength'=>32, 'unique'=>true), 'htmlOptions'=>array('maxlength'=>'32', 'autocomplete'=>'off'));
        $fields['separatorAccount']['password']	= array('type'=>'password', 'title'=>A::t('users', 'Password'), 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'password', 'minLength'=>6, 'maxLength'=>25), 'encryption'=>array('enabled'=>CConfig::get('password.encryption'), 'encryptAlgorithm'=>CConfig::get('password.encryptAlgorithm'), 'encryptSalt'=>$salt), 'htmlOptions'=>array('maxlength'=>'25', 'placeholder'=>'&#9679;&#9679;&#9679;&#9679;&#9679;'));
        if($fieldConfirmPassword !== 'no') $fields['separatorAccount']['passwordRetype'] = array('type'=>'password', 'title'=>A::t('users', 'Confirm Password'), 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'confirm', 'confirmField'=>'password', 'minLength'=>6, 'maxlength'=>20), 'htmlOptions'=>array('maxlength'=>'20', 'placeholder'=>'&#9679;&#9679;&#9679;&#9679;&#9679;'));
		$fields['separatorAccount']['salt']	= array('type'=>'hidden', 'default'=>$salt);
        $fields['separatorAccount']['language_code'] = array('type'=>'select', 'title'=>A::t('users', 'Preferred Language'), 'tooltip'=>'', 'default'=>A::app()->getLanguage(), 'validation'=>array('required'=>true, 'type'=>'set', 'source'=>array_keys($langList)), 'data'=>$langList);
    ...
    if($fieldCountry !== 'no' && $fieldState !== 'no'){
        A::app()->getClientScript()->registerScript(
            ...
            '$(document).ready(function(){
                users_ChangeCountry(
                    "frmUserAdd","'.$countryCode.'","'.$stateCode.'"
                );
            });',
            1
        );        
