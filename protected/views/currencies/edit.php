...
<div class="bloc">
    <div class="title"><?php echo A::t('app', 'Edit Currency'); ?></div>
    <div class="content">
    <?php
        echo CWidget::create('CDataForm', array(
            ...
            'successUrl'=>'currencies/manage/msg/updated',
            ...
            'fields'=>array(
                ...
                'rate'       =>array('type'=>'textbox', 'title'=>A::t('app', 'Rate'), 'tooltip'=>A::t('app', 'Relative to the default currency'), 'default'=>'1.000', 'validation'=>array('required'=>true, 'type'=>'float', 'maxLength'=>10), 'htmlOptions'=>array('maxLength'=>'10', 'class'=>'small')),
				...
				'is_default' =>array('type'=>'checkbox', 'title'=>A::t('app', 'Default'), 'validation'=>array('type'=>'set', 'source'=>array(0,1)), 'htmlOptions'=>($currency->is_default ? array('disabled'=>'disabled', 'uncheckValue'=>$currency->is_default) : '')),
				'is_active'  =>array('type'=>'checkbox', 'title'=>A::t('app', 'Active'), 'validation'=>array('type'=>'set', 'source'=>array(0,1)), 'htmlOptions'=>($currency->is_default ? array('disabled'=>'disabled', 'uncheckValue'=>$currency->is_active) : '')),
            ),
            'buttons'=>array(
