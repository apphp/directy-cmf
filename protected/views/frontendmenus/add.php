<?php
	...
	$this->_breadCrumbs[] = array('label'=>A::t('app', 'Add Menu'));
...
<div class="bloc">	
	...
	<?php
		...
		$fields['sort_order'] = array('type'=>'textbox', 'title'=>A::t('app', 'Sort Order'), 'tooltip'=>'', 'default'=>FrontendMenus::model()->count()+1, 'validation'=>array('required'=>true, 'type'=>'numeric'), 'htmlOptions'=>array('maxlength'=>'3', 'class'=>'small'));
		...
		echo CWidget::create('CDataForm', array(
			...
			'translationFields' => array(
				'name' => array('type'=>'textbox', 'title'=>A::t('app', 'Menu Title'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>true, 'type'=>''), 'htmlOptions'=>array('title'=>'')),
			),
			'buttons'=>array(
