	...
	<?php
		...
		echo CWidget::create('CDataForm', array(
			...
			'fields'			=> array(
				...
				'merchant_code'     => array('type'=>'textbox', 'title'=>A::t('app', 'Merchant Code'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'any', 'maxLength'=>40), 'htmlOptions'=>array('maxLength'=>'60', 'class'=>'middle'), 'disabled'=>!$required['merchant_code']),
				'merchant_key'      => array('type'=>'textbox', 'title'=>A::t('app', 'Merchant Key'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'any', 'maxLength'=>40), 'htmlOptions'=>array('maxLength'=>'60', 'class'=>'large'), 'disabled'=>!$required['merchant_key']),
