...
<div class="bloc">
    <div class="title"><?php echo A::t('app', 'Edit State'); ?> <a class="back-link" href="subLocations/manage/country/<?php echo $countryId; ?>"><?php echo A::t('app', 'Back'); ?></a></div>
    <div class="content">        
    <?php
        echo CWidget::create('CDataForm', array(
            ...
            'successUrl'=>'subLocations/manage/country/'.$countryId.'/msg/updated',
            ...
            'fields'=>array(
                ...
                'is_active'  => array('type'=>'checkbox', 'title'=>A::t('app', 'Active'), 'validation'=>array('type'=>'set', 'source'=>array(0,1)), 'htmlOptions'=>array()),
