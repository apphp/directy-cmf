...
<div class="bloc">
	...
	<?php 
		...
		echo CWidget::create('CGridView', array(
			...
			'sorting'			=> true,
			'filters'			=> array(
                'item_type'  		=> array('title'=>A::t('app', 'Type'), 'type'=>'enum', 'operator'=>'=', 'width'=>'120px', 'source'=>$itemTypes),
            ),
			'fields'			=> array(
				...
				'started_at' 		=> array('title'=>A::t('app', 'Date Created'), 'type'=>'datetime', 'class'=>'center', 'headerClass'=>'center', 'definedValues'=>array('0000-00-00'=>'--'), 'width'=>'140px', 'format'=>$dateFormat),
				'expires_at' 		=> array('title'=>A::t('app', 'Expires'), 'type'=>'datetime', 'class'=>'center', 'headerClass'=>'center', 'definedValues'=>array('0000-00-00'=>A::t('app', 'Never')), 'width'=>'140px', 'format'=>$dateFormat),
				'activity_counter'  => array('title'=>A::t('app', 'Activity Counter'), 'type'=>'label', 'class'=>'center', 'headerClass'=>'center', 'width'=>'100px'),
				'last_activity'  	=> array('title'=>A::t('app', 'Last Activity'), 'type'=>'datetime', 'class'=>'center', 'headerClass'=>'center', 'definedValues'=>array('0000-00-00'=>A::t('app', 'Never')), 'width'=>'160px', 'format'=>$dateFormat),
