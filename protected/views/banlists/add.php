...
<div class="bloc">
    <div class="title"><?php echo A::t('app', 'Add New Item'); ?></div>
    <div class="content">        
    <?php
		...
		$fields['expires_at'] = array('type'=>'datetime', 'title'=>A::t('app', 'Expires'), 'defaultAddMode'=>'0000-00-00', 'validation'=>array('required'=>false, 'type'=>'date', 'maxLength'=>10, 'minValue'=>date('Y-m-d'), 'maxValue'=>''), 'htmlOptions'=>array('maxlength'=>'10', 'style'=>'width:100px'), 'definedValues'=>array('0000-00-00'=>''));
