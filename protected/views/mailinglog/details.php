    ...
    <?php
		echo CWidget::create('CDataForm', array(
			...
			'fields'			=> array(
				...
				'status' 				=> array('type'=>'label', 'title'=>A::t('app', 'Status'), 'default'=>'', 'tooltip'=>'', 'definedValues'=>array('0'=>'<span class="label-red badge-square">'.A::t('app', 'No Sent').'</span>', '1'=>'<span class="label-green badge-square">'.A::t('app', 'Sent').'</span>')),
