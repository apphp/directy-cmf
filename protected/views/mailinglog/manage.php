	...
	<?php 
		...
		echo CWidget::create('CGridView', array(
			...
			'fields'			=> array(
				...
				'sent_at' 			=> array('title'=>A::t('app', 'Date Sent'), 'type'=>'datetime', 'class'=>'center', 'headerClass'=>'center', 'definedValues'=>array('0000-00-00'=>A::t('app', 'Never')), 'width'=>'140px', 'format'=>$dateTimeFormat),
