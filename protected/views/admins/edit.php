		...
		echo CWidget::create('CDataForm', array(
			...
			'fields'			=> array(
				'separatorPersonal' => array(
					...
					'birth_date'    	=> array('type'=>'datetime', 'title'=>A::t('app', 'Birth Date'), 'defaultEditMode'=>null, 'validation'=>array('required'=>false, 'type'=>'date', 'maxLength'=>10, 'minValue'=>(date('Y')-110).'-00-00', 'maxValue'=>date('Y-m-d')), 'maxDate'=>'1', 'yearRange'=>'-100:+0', 'htmlOptions'=>array('maxlength'=>'10', 'style'=>'width:100px')),
