...
<div class="bloc">
	...
	<?php		
		...
		$languageEvent = (Admins::hasPrivilege('site_settings', 'edit')) ? array('submit'=>'$(this).closest("form").find("input[name=act]").val("changeLang");$(this).closest("form").attr("action","settings/visual");$(this).closest("form").submit();') : array();
		...
		echo CWidget::create('CFormView', array(
			...
			'buttons'=> Admins::hasPrivilege('site_settings', 'edit') ? 
				array(
					...
					'cancel'=>array('type'=>'button', 'value'=>A::t('app', 'Cancel'), 'htmlOptions'=>array('name'=>'', 'class'=>'button white', 'onclick'=>"$(location).attr('href','settings/visual');")))
				: array(),
			'events'=>array(
