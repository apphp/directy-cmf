<?php
    ...
    $this->_breadCrumbs = array(
		...
		array('label'=>A::t('app', 'Locations'), 'url'=>$backendPath.'locations/manage'),
		array('label'=>A::t('app', $selectedCountry->country_name), 'url'=>$backendPath.'subLocations/manage/country/'.$selectedCountry->id),
    );    
?>
...
<div class="bloc">
    <div class="title"><?= A::t('app', 'Add New State'); ?> <a class="back-link" href="<?=$backendPath;?>subLocations/manage/country/<?= $selectedCountry->id; ?>"><?= A::t('app', 'Back'); ?></a></div>
    <div class="content">        
	<?php
		echo CWidget::create('CDataForm', array(
			'model'				=> 'States',
			'primaryKey'		=> 0,
			'action'			=> $backendPath.'subLocations/add/country/'.$selectedCountry->id,
			'successUrl'		=> $backendPath.'subLocations/manage/country/'.$selectedCountry->id,
			'cancelUrl'			=> $backendPath.'subLocations/manage/country/'.$selectedCountry->id,
			'method'			=> 'post',
			'htmlOptions'		=> array(
				'name'				=> 'frmStateAdd',
				'autoGenerateId'	=> true
