<?php
    ...
    $this->_breadCrumbs = array(
		...
		array('label'=>A::t('app', $countryName), 'url'=>$backendPath.'subLocations/manage/country/'.$countryId),
...
<div class="bloc">
    <div class="title"><?= A::t('app', 'Edit State'); ?> <a class="back-link" href="<?=$backendPath;?>subLocations/manage/country/<?= $countryId; ?>"><?= A::t('app', 'Back'); ?></a></div>
    <div class="content">        
    <?php
        echo CWidget::create('CDataForm', array(
            ...
            'primaryKey'		=> $id,
            'operationType'		=> 'edit',
            'action'			=> $backendPath.'subLocations/edit/id/'.$id,
            'successUrl'		=> $backendPath.'subLocations/manage/country/'.$countryId,
            'cancelUrl'			=> $backendPath.'subLocations/manage/country/'.$countryId,
            'method'			=> 'post',
            'htmlOptions'		=> array(
                'name'				=> 'frmStateEdit',
                'autoGenerateId'	=> true
