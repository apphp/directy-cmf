<?php
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('app', 'Currencies'), 'url'=>$backendPath.'currencies/manage'),
...
<div class="bloc">
    ...
    <?php
        echo CWidget::create('CDataForm', array(
            ...
            'operationType'		=> 'edit',
            'action'			=> $backendPath.'currencies/edit/id/'.$currency->id,
            'successUrl'		=> $backendPath.'currencies/manage',
            'cancelUrl'			=> $backendPath.'currencies/manage',
