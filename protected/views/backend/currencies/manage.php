<?php
	...
	$this->_activeMenu = $backendPath.'currencies/';
    ...
    <div class="content">
		<?php 
		    ...
		    if(Admins::hasPrivilege('currencies', 'edit')){
			    echo '<a href="'.$backendPath.'currencies/add" class="add-new">'.A::t('app', 'Add New').'</a> &nbsp; ';
				echo '<a href="'.$backendPath.'currencies/updateRates" class="update link-prevent-double-click">'.A::t('app', 'Update Rates').'</a>';
		    }
            
            echo CWidget::create('CGridView', array(
                'model'			=> 'Currencies',
                'actionPath'	=> $backendPath.'currencies/manage',
                ...
                'fields'		=> array(
                	...
                	'rate'         => array('title'=>A::t('app', 'Rate'), 'type'=>'decimal', 'class'=>'center', 'headerClass'=>'center', 'width'=>'85px', 'format'=>$numberFormat, 'decimalPoints'=>4),
					...
					'is_active'    => array('title'=>A::t('app', 'Active'), 'type'=>'link', 'align'=>'', 'width'=>'90px', 'class'=>'center', 'headerClass'=>'center', 'isSortable'=>false, 'linkUrl'=>$backendPath.'currencies/changeStatus/id/{id}', 'linkText'=>'', 'definedValues'=>array('0'=>'<span class="badge-red">'.A::t('app', 'No').'</span>', '1'=>'<span class="badge-green">'.A::t('app', 'Yes').'</span>'), 'htmlOptions'=>array('class'=>'tooltip-link', 'title'=>A::t('app', 'Click to change status'))),
                ),
				'actions'		=> array(
					'edit' => array(
						'disabled'	=> !Admins::hasPrivilege('currencies', 'edit'),
						'link'		=> $backendPath.'currencies/edit/id/{id}', 'imagePath'=>'templates/backend/images/edit.png', 'title'=>A::t('app', 'Edit this record')
					),
					'delete' => array(
						'disabled'	=> !Admins::hasPrivilege('currencies', 'edit'),
						'link'		=> $backendPath.'currencies/delete/id/{id}', 'imagePath'=>'templates/backend/images/delete.png', 'title'=>A::t('app', 'Delete this record'), 'onDeleteAlert'=>true
					)
				),
            ));        
        ?>    
