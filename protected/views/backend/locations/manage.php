...
<div class="bloc">
	...
	<?php 
		...
		if(Admins::hasPrivilege('locations', 'edit')){
			echo '<a href="'.$backendPath.'locations/add" class="add-new">'.A::t('app', 'Add New').'</a>';
		}
   
		echo CWidget::create('CGridView', array(
			'model'         => 'Countries',
			'actionPath'    => $backendPath.'locations/manage',
			'defaultOrder'  => array('sort_order'=>'DESC', 'name'=>'ASC'),
			'passParameters'=> true,
			'pagination'    => array('enable'=>true, 'pageSize'=>20),
			'sorting'       => true,
			'filters'       => array(
				//'id'             => array('title'=>A::t('app', 'Name'), 'table'=>CConfig::get('db.prefix').'countries', 'type'=>'textbox', 'operator'=>'like%', 'width'=>'140px', 'maxLength'=>'', 'autocomplete'=>array('enable'=>true, 'ajaxHandler'=>$backendPath.'Ajax/getLocations', 'minLength'=>2, 'returnId'=>true)),
			...
			'fields'=>array(
				...
				'is_default'     => array('title'=>A::t('app', 'Default'), 'type'=>'enum', 'class'=>'center', 'headerClass'=>'center', 'source'=>array('0'=>'<span class="badge-gray badge-square">'.A::t('app', 'No').'</span>', '1'=>'<span class="badge-green badge-square">'.A::t('app', 'Yes').'</span>'), 'width'=>'110px'),
				'is_active' 	 => array('title'=>A::t('app', 'Active'), 'type'=>'link', 'align'=>'', 'width'=>'90px', 'class'=>'center', 'headerClass'=>'center', 'isSortable'=>false, 'linkUrl'=>$backendPath.'locations/changeStatus/id/{id}/page/{page}', 'linkText'=>'', 'definedValues'=>array('0'=>'<span class="badge-red">'.A::t('app', 'No').'</span>', '1'=>'<span class="badge-green">'.A::t('app', 'Yes').'</span>'), 'htmlOptions'=>array('class'=>'tooltip-link', 'title'=>A::t('app', 'Click to change status'))),
				'sub_locations_link' => array('title'=>A::t('app', 'Sub-Locations'), 'type'=>'link', 'class'=>'center', 'headerClass'=>'center', 'width'=>'90px', 'isSortable'=>false, 'linkUrl'=>$backendPath.'subLocations/manage/country/{id}', 'linkText'=>A::t('app', 'States'), 'htmlOptions'=>array('class'=>'subgrid-link'), 'prependCode'=>'[ ', 'appendCode'=>' ]'),
			...
			'actions'=>array(
				'edit'   => array(
					...
					'link'		=> $backendPath.'locations/edit/id/{id}', 'imagePath'=>'templates/backend/images/edit.png', 'title'=>A::t('app', 'Edit this record')
				),
				'delete' => array(
					'disabled'	=> !Admins::hasPrivilege('locations', 'edit'),
					'link'		=> $backendPath.'locations/delete/id/{id}', 'imagePath'=>'templates/backend/images/delete.png', 'title'=>A::t('app', 'Delete this record'), 'onDeleteAlert'=>true
				)
			),
		));
	?>        
