...
<div class="bloc">
	...
	<?php 
		...
		if(Admins::hasPrivilege('ban_lists', 'edit')){
			echo '<a href="'.$backendPath.'banLists/add" class="add-new">'.A::t('app', 'Add New').'</a>';
		}
   
		echo CWidget::create('CGridView', array(
			'model'				=> 'BanLists',
			'actionPath'		=> $backendPath.'banLists/manage',
			...
			'filters'			=> array(
				...
				'item_value' 	    => array('title'=>A::t('app', 'Item'), 'type'=>'textbox', 'table'=>'', 'operator'=>'%like%', 'default'=>'', 'width'=>'', 'maxLength'=>'20', 'htmlOptions'=>array('class'=>'medium')),
            ),
			'fields'			=> array(
				...
				'is_active'  		=> array('title'=>A::t('app', 'Active'), 'type'=>'link', 'align'=>'', 'width'=>'70px', 'class'=>'center', 'headerClass'=>'center', 'linkUrl'=>$backendPath.'banLists/changeStatus/id/{id}/page/{page}', 'linkText'=>'', 'definedValues'=>array('0'=>'<span class="badge-red">'.A::t('app', 'No').'</span>', '1'=>'<span class="badge-green">'.A::t('app', 'Yes').'</span>'), 'htmlOptions'=>array('class'=>'tooltip-link', 'title'=>A::t('app', 'Click to change status'))),
			),
			'actions'			=> array(
				'edit'   => array(
					'disabled'		=> !Admins::hasPrivilege('ban_lists', 'edit'),
					'link'			=> $backendPath.'banLists/edit/id/{id}', 'imagePath'=>'templates/backend/images/edit.png', 'title'=>A::t('app', 'Edit this record')
				),
				'delete' => array(
					'disabled'		=> !Admins::hasPrivilege('ban_lists', 'edit'),
					'link'			=> $backendPath.'banLists/delete/id/{id}', 'imagePath'=>'templates/backend/images/delete.png', 'title'=>A::t('app', 'Delete this record'), 'onDeleteAlert'=>true
				)
			),
		));
	?>        
