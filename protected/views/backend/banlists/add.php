...
<div class="bloc">
    ...
    <?php
        ...
        echo CWidget::create('CDataForm', array(
			...
			///'primaryKey'		=> 0,
            'operationType'		=> 'add',
            'action'			=> $backendPath.'banLists/add',
...
<?php
	A::app()->getClientScript()->registerScript(
		...
		'$("#frmBanListsAdd_item_type").on("change", function(){
			...
			unsetMask("frmBanListsAdd_item_value");
			if(itemType == "email_address"){
				...
				setIpAddressMask("frmBanListsAdd_item_value");
			}
		});
		...
		'.($itemType == '' || $itemType == 'ip_address' ? 'setIpAddressMask("frmBanListsAdd_item_value");' : ''),
		4
	);
