...
<div class="bloc">
	...
	<?php		
		...
		echo CWidget::create('CFormView', array(
			'action'=>$backendPath.'settings/local',
			'method'=>'post',
			'htmlOptions'=>array(
			...
			'fields'=>array(
				'act' =>array('type'=>'hidden', 'value'=>'send'),
	          	'separatorDateTimeFormats' =>array(
					...
					'shortTimeFormat'   => array('type'=>'textbox', 'value'=>$settings->shorttime_format, 'title'=>A::t('app', 'Short Time Format'), 'tooltip'=>A::t('app', 'Short Time Format Tooltip'), 'mandatoryStar'=>false, 'prependCode'=>$shortTimeFormatsList, 'appendCode'=>' &nbsp;'.$shortTimeFormatSample, 'htmlOptions'=>array('maxLength'=>'3', 'style'=>'width:60px')),
			...
			'buttons' => Admins::hasPrivilege('site_settings', 'edit') ? 
				array(
					...
					'cancel' => array('type'=>'button', 'value'=>A::t('app', 'Cancel'), 'htmlOptions'=>array('name'=>'', 'class'=>'button white', 'onclick'=>"$(location).attr('href','".$backendPath."settings/local');")))
				: array(),
			'events' => array(
