...
<div class="bloc">
	...
	<?php		
		...
		echo CWidget::create('CFormView', array(
			'action'=>$backendPath.'settings/email',
			'method'=>'post',
			'htmlOptions'=>array(
			...
			'fields'=>array(
				'act' =>array('type'=>'hidden', 'value'=>'send'),
	         	...
	         	'separatorEmailLog' => array(
					...
					'mailing_log'	=> array('type'=>'checkbox', 'title'=>A::t('app', 'Enable Mail Logging'), 'tooltip'=>'', 'mandatoryStar'=>false, 'value'=>'1', 'checked'=>($settings->mailing_log ? true : false), 'htmlOptions'=>array(), 'viewType'=>'custom', 'appendCode'=>($settings->mailing_log ? ' &nbsp; [ <a class="inline mt5" href="'.$backendPath.'mailingLog/manage">'.A::t('app', 'Mailing Log').'</a> ]' : '')),
	            ),
			),
			'buttons'=> Admins::hasPrivilege('site_settings', 'edit') ? 
				array(
					...
					'cancel'=>array('type'=>'button', 'value'=>A::t('app', 'Cancel'), 'htmlOptions'=>array('name'=>'', 'class'=>'button white', 'onclick'=>"$(location).attr('href','".$backendPath."settings/email');")))
				: array(),
			'events'=>array(
