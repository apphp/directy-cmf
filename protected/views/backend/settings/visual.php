...
<div class="bloc">
	...
	<?php		
		...
		$languageEvent = (Admins::hasPrivilege('site_settings', 'edit')) ? '$(this).closest("form").find("input[name=act]").val("changeLang");$(this).closest("form").attr("action","'.$backendPath.'settings/visual");$(this).closest("form").submit();' : false;

		echo CWidget::create('CFormView', array(
			'action'=>$backendPath.'settings/visual',
			'method'=>'post',
			'htmlOptions'=>array(
			...
			'buttons' =>
				...
				array('submit'=>array('type'=>'submit', 'value'=>A::t('app', 'Update')), 'cancel'=>array('type'=>'button', 'value'=>A::t('app', 'Cancel'), 'htmlOptions'=>array('name'=>'', 'class'=>'button white', 'onclick'=>"$(location).attr('href','".$backendPath."settings/visual');"))) :
				array(),
			'events'=>array(
