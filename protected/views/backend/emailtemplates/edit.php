<?php
	...
	$this->_activeMenu = $backendPath.'emailTemplates/';
    $this->_breadCrumbs = array(
        array('label'=>A::t('app', 'Mail Settings'), 'url'=>$backendPath.'emailTemplates/manage'),
        array('label'=>A::t('app', 'Email Templates'), 'url'=>$backendPath.'emailTemplates/manage'),
...
<div class="bloc">
	...
	<?php if(Admins::hasPrivilege('email_templates', array('view', 'edit'))): ?>
	    <a href="<?=$backendPath?>emailTemplates/sendTestEmail/id/<?= $template->id;?>" class="prompt-action float-right email-data ml5" data-prompt-message="<?= A::te('app', 'Are you sure you want to send this email?');?>"><b class="icon-email">&nbsp;</b> <?= A::t('app', 'Send a Test Email')?></a>
        <?php if(A::app()->getRequest()->isPostRequest()): ?><div class="clearboth"></div><?php endif; ?>
	<?php endif; ?>
	...
	<?php
		echo CWidget::create('CDataForm', array(
			...
			'operationType'		=> 'edit',
			'action'			=> $backendPath.'emailTemplates/edit/id/'.$template->id,
			'successUrl'		=> $backendPath.'emailTemplates/manage',
			'cancelUrl'			=> $backendPath.'emailTemplates/manage',
    ...
    <div class="fieldset-content">
        ...
        <ul>
            ...
            <li>{SITE_BO_URL} - <?= A::t('app', 'website backend URL'); ?></li>
