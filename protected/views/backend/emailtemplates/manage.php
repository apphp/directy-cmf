...
<div class="bloc">
	...
	<?php 
		...
		if(Admins::hasPrivilege('email_templates', 'edit')){
			echo '<a href="'.$backendPath.'emailTemplates/add" class="add-new">'.A::t('app', 'Add New').'</a>';
		}
   
		echo CWidget::create('CGridView', array(
			'model'				=> 'EmailTemplates',
			'actionPath'		=> $backendPath.'emailTemplates/manage',
			...
			'fields'			=> array(
				'template_name'    => array('title'=>A::t('app', 'Name'), 'type'=>'label', 'class'=>'left', 'headerClass'=>'left', 'width'=>'290px'),
			...
			'actions'			=> array(
				'edit'   		=> array(
					...
					'link'			=> $backendPath.'emailTemplates/edit/id/{id}', 'imagePath'=>'templates/backend/images/edit.png', 'title'=>A::t('app', 'Edit this record')
				),
				'delete' 		=> array(
					'disabled'	    => !Admins::hasPrivilege('email_templates', 'edit'),
					'link'		    => $backendPath.'emailTemplates/delete/id/{id}', 'imagePath'=>'templates/backend/images/delete.png', 'title'=>A::t('app', 'Delete this record'), 'onDeleteAlert'=>true
				)
			),
		));
	?>        
