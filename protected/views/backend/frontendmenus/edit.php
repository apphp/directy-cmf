<?php
	...
	if($parentId && $parentName != ''){
		...
		$breadCrumbs[] = array('label'=>A::t('app', $parentName), 'url'=>$backendPath.'frontendMenus/manage/pid/'.$parentId);
...
<div class="bloc">
	...
	<?php
		...
		echo CWidget::create('CDataForm', array(
			...
			'primaryKey'		=> $id,
			'operationType'		=> 'edit',
			'action'			=> $backendPath.'frontendMenus/edit/id/'.$id.($parentId ? '/pid/'.$parentId : ''),
			'successUrl'		=> $backendPath.'frontendMenus/manage/pid/'.($parentId ? $parentId : '0'),
			'cancelUrl'			=> $backendPath.'frontendMenus/manage'.($parentId ? '/pid/'.$parentId : ''),
			//'passParameters'  => true,
