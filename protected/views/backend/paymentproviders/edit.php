<?php
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('app', 'Payment Providers'), 'url'=>$backendPath.'paymentProviders/manage'),
...
<div class="bloc">
	...
	<?php
		...
		echo CWidget::create('CDataForm', array(
			...
			'operationType'		=> 'edit',
			'action'			=> $backendPath.'paymentProviders/edit/id/'.$paymentProvider->id,
			'successUrl'		=> $backendPath.'paymentProviders/manage',
			'cancelUrl'			=> $backendPath.'paymentProviders/manage',
			...
			'fields'			=> array(
				...
				'merchant_id'       => array('type'=>'textbox', 'title'=>A::t('app', 'Merchant ID'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'any', 'maxLength'=>40), 'htmlOptions'=>array('maxLength'=>'255', 'class'=>'middle'), 'disabled'=>!$required['merchant_id']),
				'merchant_code'     => array('type'=>'textbox', 'title'=>A::t('app', 'Merchant Code'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'any', 'maxLength'=>60), 'htmlOptions'=>array('maxLength'=>'60', 'class'=>'middle'), 'disabled'=>!$required['merchant_code']),
				'merchant_key'      => array('type'=>'textbox', 'title'=>A::t('app', 'Merchant Key'), 'tooltip'=>'', 'default'=>'', 'validation'=>array('required'=>true, 'type'=>'any', 'maxLength'=>60), 'htmlOptions'=>array('maxLength'=>'60', 'class'=>'middle'), 'disabled'=>!$required['merchant_key']),
