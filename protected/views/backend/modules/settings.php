<?php
    ...
    $this->_breadCrumbs = array(
		...
		array('label'=>A::t($module->code, $module->name), 'url'=>$backendPath.'modules/settings/code/'.$module->code),
    ...
    <div class="content">        
   	<?php 
		...
		if(is_array($moduleSettings) && count($moduleSettings) > 0){
			...
			echo CHtml::openForm($backendPath.'modules/settings/code/'.$module->code, 'post', array('name'=>$formName, 'class'=>'widget-cformview', 'autoGenerateId'=>true));
			...
			?>
            <table id="tblModulesSettings" class="grid-view-table">
			<thead>
                <tr>
                    <th class="left" width="200px"><?= A::t('app', 'Name'); ?></th>
            ...
            <?php
                ...
                foreach($moduleSettings as $setting){
                    ...
                    ?>
                    <tr>
                        <td class="left" width="200px"><?= CHtml::label($settingName, $fieldName); ?></td>
                        <td class="left"><?= A::t($setting['module_code'], $setting['description']); ?></td>
                        <td class="right column-last" width="300px">
                        <?php
                        echo $hiddenField;
			...
			<div class="buttons-wrapper">
				...
				<input class="button white" onclick="$(location).attr('href','<?=$backendPath;?>modules/<?= ($module->is_system ? 'system' : 'application');?>');" value="<?= A::t('app', 'Cancel'); ?>" type="button">
			</div>
			<?php } ?>
		<?php 
