...
<div class="bloc">
    ...
    <div class="content">		
		...
		<thead>
		<tr>
			<th class="left" colspan="2"><?= A::t('app', 'Module Name'); ?></th>
				...
				foreach($modulesList as $module){
					...
					if(Admins::hasPrivilege('modules', 'edit_management')){
                        echo '<td class="actions">';
                            ...
                            echo (!empty($moduleVersion) && $module['version'] < $moduleVersion ? '<a href="'.$backendPath.'modules/update/code/'.$module['code'].'" class="tooltip-link" title="'.A::t('app', 'Update to version {version}', array('{version}'=>$moduleVersion)).'"><img src="templates/backend/images/update.png" alt="update"></a>' : '');
                            echo '<a href="'.$backendPath.'modules/edit/id/'.$module['id'].'" class="tooltip-link" title="'.A::t('app', 'Edit this record').'"><img src="templates/backend/images/edit.png" alt="edit"></a>';
                            if($removalbe){    
			...
			if(is_array($notInstalledModulesList)){
				foreach($notInstalledModulesList as $code => $module){
					echo '<tr>
						...
						<td class="left" width="124px">'.$module['name'].'</td>
