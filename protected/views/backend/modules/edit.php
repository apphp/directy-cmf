<?php
    ...
    $this->_breadCrumbs = array(
		...
		array('label'=>A::t('app', ($module->is_system) ? 'System Modules' : 'Application Modules'), 'url'=>$backendPath.'modules/'.(($module->is_system) ? 'system' : 'application')),
...
<div class="bloc">
	...
	<?php
		...
		<a href="<?=$backendPath;?>modules/deleteTestData/id/<?= $module->id; ?>" class="delete-all prompt-delete align-right" data-prompt-message="<?= A::te('app', 'Are you sure you want to delete all test data for module {module}?', array('{module}'=>$module->name)); ?>"><?= A::t('app', 'Delete All Test Data'); ?></a>
	<?php endif; ?>
    ...
    <?php        
        echo CWidget::create('CDataForm', array(
            ...
            'operationType'		=> 'edit',
            'action'			=> $backendPath.'modules/edit/id/'.$module->id,
            'successUrl'		=> $backendPath.'modules/'.($module->is_system ? 'system' : 'application'),
            'cancelUrl'			=> $backendPath.'modules/'.($module->is_system ? 'system' : 'application'),
