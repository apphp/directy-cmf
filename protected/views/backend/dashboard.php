...
<div class="bloc bloc-right" id="blocStatistics">
    <?php
        ...
        <tbody>
            <tr>
                <td width="40%">'.A::t('app', 'Today').': </td>
                <td><b>'.$todayDate.'</b></td>                            
            </tr>
            <tr>
                <td>'.A::t('app', 'Application').': </td>
                <td><b>'.$scriptName.'</b></td>                            
            </tr>
            <tr>
                <td>'.A::t('app', 'Version').': </td>
                <td><b>'.$scriptVersion.'</b></td>                            
            </tr>
        </tbody>
        </table>';
        ...
        <tbody>
            <tr>
                <td width="40%">'.A::t('app', 'Last Login').': </td>
                <td><b>'.$lastLoginDate.'</b></td>                            
            </tr>
        </tbody>
        </table>';
        ...
        $tabStat3 = '<table>
            <tr>
                <td width="40%">'.A::t('app', 'Total Admins').': </td>
                <td><b>'.$adminsCount.'</b></td>                            
            </tr>
            <tr>
                <td>'.A::t('app', 'Last 5 registered admins').': </td>
                <td><b>'.$lastAdminsList.'</b></td>                            
            </tr>
        </tbody>
        </table>';
