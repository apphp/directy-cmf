        ...
        CWidget::create('CGridView', array(
            ...
            'actions'=>array(
                'edit'    => array(
                    ...
                    'link'=>$backendPath.'socialNetworks/edit/id/{id}', 'imagePath'=>'templates/backend/images/edit.png', 'title'=>A::t('app', 'Edit this record')
                ),
                'delete'=>array(
                    'disabled'=>!Admins::hasPrivilege('modules', 'edit') || !Admins::hasPrivilege('social_networks', 'delete'),
                    'link'=>$backendPath.'socialNetworks/delete/id/{id}', 'imagePath'=>'templates/backend/images/delete.png', 'title'=>A::t('app', 'Delete this record'), 'onDeleteAlert'=>true
                )
            ),
            'return'=>false,
        ));
