<?php
	...
	$this->_activeMenu = $backendPath.'admins/'.($isMyAccount ? 'myAccount' : '');
...
<div class="bloc">
    ...
    <?php
		echo CWidget::create('CDataForm', array(
			...
			'primaryKey'		=> $admin->id,
			'operationType'		=> 'edit',
			'action'			=> $backendPath.'admins/edit/id/'.$admin->id,
			'successUrl'		=> $isMyAccount ? '' : $backendPath.'admins/manage',
			...
			'fields'			=> array(
				'separatorPersonal' => array(
					'separatorInfo' 	=> array('legend'=>A::t('app', 'Personal Information'), 'disabled'=>false),
					...
					'birth_date'        => array('type'=>'datetime', 'title'=>A::t('app', 'Birth Date'), 'defaultEditMode'=>null, 'validation'=>array('required'=>false, 'type'=>'date', 'maxLength'=>10, 'minValue'=>(date('Y')-110).'-00-00', 'maxValue'=>date('Y-m-d')), 'htmlOptions'=>array('maxlength'=>'10', 'style'=>'width:100px'), 'definedValues'=>array(), 'viewType'=>'date', 'dateFormat'=>'yy-mm-dd', 'timeFormat'=>'HH:mm', 'buttonTrigger'=>true, 'minDate'=>'', 'maxDate'=>'1', 'yearRange'=>'-110:+0'),
					...
					'avatar' 		=> array(
						...
						'validation'    => array('required'=>false, 'type'=>'image', 'maxSize'=>'200k', 'maxWidth'=>'300px', 'maxHeight'=>'300px', 'targetPath'=>'templates/backend/images/accounts/', 'mimeType'=>'image/jpeg, image/jpg, image/png, image/gif', 'fileName'=>'adm_'.CHash::getRandomString(10)),
						'imageOptions'  => array('showImage'=>true, 'showImageName'=>true, 'showImageSize'=>true, 'showImageDimensions'=>true, 'imageClass'=>'avatar'),
						//'watermarkOptions'	=> array('enable'=>true, 'text'=>'Avatar'),
						'deleteOptions' => array('showLink'=>true, 'linkUrl'=>$backendPath.'admins/edit/id/'.$admin->id.'/avatar/delete', 'linkText'=>A::t('app', 'Delete')),
				...
				'separatorOther' 	=> array(
					'separatorInfo' 	=> array('legend'=>A::t('app', 'Other'), 'disabled'=>false),
                    ...
                    //'password_changed_at' => array('type'=>'datetime', 'title'=>A::t('app', 'Last Password Changed'), 'defaultEditMode'=>null, 'viewType'=>'datetime', 'dateFormat'=>'yy-mm-dd', 'timeFormat'=>'HH:mm:ss', 'validation'=>array('required'=>false, 'type'=>'date', 'maxLength'=>19), 'maxDate'=>'1', 'yearRange'=>'-100:+0', 'htmlOptions'=>array('maxlength'=>'19', 'style'=>'width:140px')),
