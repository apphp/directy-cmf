<?php
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('app', 'Languages'), 'url'=>$backendPath.'languages/manage'),
...
<div class="bloc">
    ...
    <?php
		echo CWidget::create('CDataForm', array(
			...
			'operationType'		=> 'edit',
			'action'			=> $backendPath.'languages/edit/id/'.$language->id,
			'successUrl'		=> $backendPath.'languages/manage',
			'cancelUrl'			=> $backendPath.'languages/manage',
			...
			'fields'			=> array(
				...
				'icon' 			=> array(
					...
					'deleteOptions' => array('showLink'=>true, 'linkUrl'=>$backendPath.'languages/edit/id/'.$language->id.'/icon/delete', 'linkText'=>A::t('app', 'Delete')),
