<?php
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('app', 'Roles & Privileges'), 'url'=>$backendPath.'roles/manage'),
...
<div class="bloc">
    ...
    <?php
        echo CWidget::create('CDataForm', array(
            ...
            'operationType'		=> 'edit',
            'primaryKey'		=> $id,
            'action'			=> $backendPath.'roles/edit/id/'.$id,
            'successUrl'		=> $backendPath.'roles/manage',
            'cancelUrl'			=> $backendPath.'roles/manage',
