<?php
	...
	if($parentId && $parentName != ''){
		...
		$breadCrumbs[] = array('label'=>A::t('app', $parentName), 'url'=>$backendPath.'backendMenus/manage/pid/'.$parentId);
	}else{
		$breadCrumbs[] = array('label'=>A::t('app', 'Backend Menu'), 'url'=>$backendPath.'backendMenus/manage');
	}
...
<div class="bloc">
    ...
    <?php
    	...
    	echo CWidget::create('CDataForm', array(
			...
			'primaryKey'			=> $id,
			'operationType'			=> 'edit',
			'action'				=> $backendPath.'backendMenus/edit/id/'.$id.($parentId ? '/pid/'.$parentId : ''),
			'successUrl'			=> $backendPath.'backendMenus/manage'.($parentId ? '/pid/'.$parentId : '/pid/0'),
			'cancelUrl'				=> $backendPath.'backendMenus/manage'.($parentId ? '/pid/'.$parentId : ''),
			...
			'fields'				=> array(
				...
				'is_system'   	=> array('type'=>'label', 'title'=>A::t('app', 'System'), 'definedValues'=>array('0'=>A::t('app', 'No'), '1'=>A::t('app', 'Yes')), 'htmlOptions'=>array()),
                ...
                'icon'				=> array(
                    ...
                    'deleteOptions' => array('showLink'=>$allowImageOptions, 'linkUrl'=>$backendPath.'backendMenus/edit/id/'.$id.($parentId ? '/pid/'.$parentId : '').'/icon/delete', 'linkText'=>A::t('app', 'Delete')),
