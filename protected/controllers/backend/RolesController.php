...
class RolesController extends CController
{
	...
	{
    	$this->redirect($this->_backendPath.'roles/manage');
	}
	...
	{		
		...
		$this->_view->render($this->_backendPath.'roles/manage');
	}
	...
	public function addAction()
	{
    	...
    	$this->_view->render($this->_backendPath.'roles/add');
	}
	...
	public function editAction($id = 0)
	{
    	...
    	$this->_view->render($this->_backendPath.'roles/edit');
	}
