...
class AdminsController extends CController
{
	...
	{
        $this->redirect($this->_backendPath.'admins/manage');
    }
    ...
    public function manageAction()
    {
        ...
        $this->_view->render($this->_backendPath.'admins/manage');
    }
    ...
    public function addAction()
    {
        ...
        $this->_view->render($this->_backendPath.'admins/add');
    }    		
    ...
    public function editAction($id = 0, $avatar = '', $isMyAccount = false)
    {
        ...
        $this->_view->render($this->_backendPath.'admins/edit');
    }
    ...
    public function changeStatusAction($id, $page = 0)
    {
    	...
    	// Allow access to edit other admins only to site owner or main admin
        if(!$isMyAccount && !CAuth::isLoggedInAs('owner', 'mainadmin') && !in_array($admin->role, array_keys($this->_view->rolesList))){
        	$this->redirect($this->_backendPath.'dashboard/index');
        }
        ...
        $this->redirect($this->_backendPath.'admins/manage'.(!empty($page) ? '?page='.(int)$page : 1));
    }
