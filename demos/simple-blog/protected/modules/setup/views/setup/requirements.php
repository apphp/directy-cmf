...
<fieldset>
	...
	<ul>
		<li><?= A::t('setup', 'PHP Version'); ?>: <i><?= $phpVersion; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
		<li><?= A::t('setup', 'PDO Extension'); ?>: <i><?= $pdoExtension; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
	</ul>
</fieldset>
...
<fieldset>
	...
	<ul>
		<li><?= A::t('setup', 'System'); ?>: <i><?= $system; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
		<li><?= A::t('setup', 'System Architecture'); ?>: <i><?= $systemArchitecture; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
		<li><?= A::t('setup', 'Build Date'); ?>: <i><?= $buildDate; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
		<li><?= A::t('setup', 'Server API'); ?>: <i><?= $serverApi; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
	</ul>
</fieldset>
...
<fieldset>
	...
	<ul>
		<li><?= A::t('setup', 'Virtual Directory Support'); ?>: <i><?= $vdSupport; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
		<li><?= A::t('setup', 'Mode_Rewrite'); ?>: <i><?= $modeRewrite; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
		<?php if (version_compare(phpversion(), '7.0.0', '<')): ?>
			<li><?= A::t('setup', 'ASP Tags'); ?>: <i><?= $aspTags; ?></i>
				<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
		<?php endif; ?>
		<li><?= A::t('setup', 'Safe Mode'); ?>: <i><?= $safeMode; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
		<li><?= A::t('setup', 'Short Open Tag'); ?>: <i><?= $shortOpenTag; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
		<li><?= A::t('setup', 'Session Support'); ?>: <i><?= $sessionSupport; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
	</ul>
</fieldset>
...
<fieldset>
	...
	<ul>
		...
		<li><?= A::t('setup', 'SMTP Port'); ?>: <i><?= $smtpPort; ?></i>
			<span class="checked">&#10004; <?= A::t('setup', 'checked!'); ?></span></li>
	</ul>
</fieldset>
