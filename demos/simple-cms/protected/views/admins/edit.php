<article>
	<h1>Administrator Account Settings (<?= $isMyAccount ? A::t('app', 'My Account') : A::t('app', 'Edit Admin') ?>)</h1>
		...
		echo CWidget::create('CDataForm', array(
			...
			'fields' => array(
				...
				'separatorOther' => array(
					...
					'created_at' => array('type' => 'label', 'title' => A::t('app', 'Time Created'), 'definedValues' => array(null => A::t('app', 'Unknown')), 'format' => $dateTimeFormat),
