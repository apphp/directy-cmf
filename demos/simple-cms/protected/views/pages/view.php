...
if (!empty($pages)) {
	...
	if (!CAuth::isLoggedIn() && $isHomePage == true) {
		echo '<div class="alert alert-info">Click <a href="login/index"><b>here</b></a> to log into the system as Site Administrator Author.</div>';
	}
